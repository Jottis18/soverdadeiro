...
app = Flask(__name__)
CORS(app, 
     origins=["https://trabalho-so-ufc.vercel.app", "http://localhost:3000", "http://localhost:3001"],
...
def root():
    ...
    return jsonify({'message': 'API do Simulador de Escalonamento funcionando!', 'version': '1.0.0'})
...
if __name__ == '__main__':
    ...
    print(f"Variáveis de ambiente: PORT={os.environ.get('PORT')}")
